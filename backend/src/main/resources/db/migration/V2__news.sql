...
INSERT INTO news (title, slug, summary, tag, tag_color, source_url, published_at, is_published, created_at, updated_at) VALUES
('Kotlin 2.2 Released', 'kotlin-2-2-released',
 ...
 'Release', '#7F52FF', 'https://kotlinlang.org/docs/whatsnew22.html', '2026-02-15 10:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Compose Multiplatform 1.8 Stable', 'compose-multiplatform-1-8-stable',
 ...
 'Compose', '#4285F4', 'https://www.jetbrains.com/lp/compose-multiplatform/', '2026-02-10 09:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Spring Boot 3.4 with Kotlin DSL Enhancements', 'spring-boot-3-4-kotlin-dsl',
 ...
 'Server', '#6DB33F', 'https://spring.io/blog', '2026-01-28 14:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Ktor 3.1 — Performance and DX Improvements', 'ktor-3-1-performance-dx',
 ...
 'Ktor', '#E44857', 'https://ktor.io/docs/welcome.html', '2026-01-20 11:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Android Studio Narwhal Announced', 'android-studio-narwhal',
 ...
 'Android', '#3DDC84', 'https://developer.android.com/studio', '2026-01-15 16:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('KotlinConf 2026 Dates Announced', 'kotlinconf-2026-dates',
 ...
 'Community', '#F7931E', 'https://kotlinconf.com', '2025-12-20 12:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Amper Build Tool Reaches Beta', 'amper-build-tool-beta',
 ...
 'Tooling', '#9C27B0', 'https://github.com/JetBrains/amper', '2025-12-10 10:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Kotlin Multiplatform Production-Ready for iOS', 'kmp-production-ready-ios',
 ...
 'KMP', '#FF6F00', 'https://kotlinlang.org/docs/multiplatform.html', '2025-11-25 09:00:00', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
